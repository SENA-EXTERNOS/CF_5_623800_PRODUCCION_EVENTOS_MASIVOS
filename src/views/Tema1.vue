  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1 Tipos de montajes para eventos presenciales, híbridos y digitales

    .row
      .col-lg-7
          p Al preparar un evento presencial, híbrido o digital, se deben tener en cuenta diversas posibilidades que existen para crear su montaje; todo dependerá de la formalidad y el protocolo que se requiera según la temática del evento y aspectos físicos, como las dimensiones del espacio donde se efectúa, número de invitados, cantidad de personas necesarias para logística, plataformas digitales a usar, etc.  
          p El montaje incluye la organización de los planos para que el personal logístico sepa exactamente donde va cada elemento y se gestione de manera eficiente todos los recursos a fin de cumplir los objetivos del evento.          
    ...
    .row.table-t1
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3.mt-5
          p.mb-0 <b>Figura 1.</b><br> <em>Características generales para crear el montaje de un evento.</em>
      .col-lg-10 
        .tabla
          table
            thead
    ...
    .row.mt-5
      .col-lg-12
        ...
        p.mb-0 Los eventos pueden desarrollarse de forma presencial, virtual o como híbridos.    
      ...
      .col-lg-8
        p.mb-0 Los eventos presenciales se desarrollan para presentar un producto o servicio, captar y fidelizar clientes o desarrollar alguna actividad lúdica para empleados. En ellos, todos los componentes se encuentran en un mismo espacio físico, existiendo contacto directo entre las personas, la cercanía y el ‘cara a cara’, son dos potentes herramientas de comunicación y conexión. 
          .cajon.color_anexo2.p-4.mt-3
            p.mb-0 Al organizar una actividad y encontrarse en el proceso de búsqueda del lugar, es muy importante definir las necesidades que tendrá según la cantidad de público que se espera y las actividades a desarrollar, de esta forma podrá contratar el sitio idóneo, pues es importante considerar que los asistentes necesitan un espacio mínimo para moverse con soltura y comodidad.
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  p.mb-0 En el siguiente anexo podrá reconocer los tipos de montaje más usados. <b>Anexo 1: tipos de montaje para eventos</b>.    
                .col-sm-auto
    ...
    .row.mt-5
      .col.lg-12
        p.mb-0 Los eventos virtuales se desarrollan a través de plataformas <i>online</i> que sirven para generar una conexión entre los asistentes ubicados en diferentes lugares, eliminando las barreras físicas y reduciendo los gastos en comparación con los eventos presenciales. Al igual que en otro tipo de eventos, en éste, los participantes pueden igualmente vivir una experiencia innovadora.  
    ...
    .row.mt-5
      .col-lg-12.titulo-img-t1
        h4 8 TIPOS DE EVENTOS VIRTUALES que se pueden desarrollar. 
      .col-lg-12.img-t1
        img(src="@/assets/curso/temas/tema1/1.svg", alt="alt")
    
    .row.mt-5
      .col-lg-12
        p.mb-0 Aunque los eventos virtuales no requieren de estructuras o montajes físicos; si requieren de unos pasos para que su desarrollo sea exitoso. Veamos a continuación que se debe tener en cuenta: 

    LineaTiempoD.color-primario.mt-5
      .row(numero="1" titulo="Paso 1")
        .col-md-12.mb-4.mb-md-0
          p Identificar la mejor metodología.  La experiencia virtual debe ser interactiva y  llamar la atención del público, por ello es necesario planear el contenido, con preguntas como:
            ul.lista-ul--color.mt-3
              li.fas.fa-check
                p.mb-0.ps-2 ¿Cuál es el tiempo disponible de los asistentes?
              li.fas.fa-check
                p.mb-0.ps-2 ¿Les gustan las nuevas tecnologías? 
              li.fas.fa-check
                p.mb-0.ps-2 ¿Cuáles son los dispositivos tecnológicos a través de los cuales se conecta la audiencia?
              li.fas.fa-check
                p.mb-0.ps-2 ¿En qué tema están interesados?
              li.fas.fa-check
                p.mb-0.ps-2 ¿Requieren interactuar entre ellos o pueden trabajar solos?
          
          p.mt-3 Esta planeación inicial permitirá determinar la metodología del evento la cual puede ser sincrónica (interacción en tiempo real a través de audio, video, y/o chat) o asincrónica (participación simultánea entre los participantes, quienes acceden a recursos en línea).
          p.mt-3 De acuerdo al Banco Interamericano de Desarrollo (2020), algunos elementos creativos que se pueden agregar a dichas metodologías son:                 
          
            ul.lista-ul--color.mt-3
              li.fas.fa-check
                p.mb-0.ps-2 Videos cortos pregrabados con líderes o personas importantes para la compañía.
              li.fas.fa-check
                p.mb-0.ps-2 Encuestas, cuestionarios o votaciones en línea.
              li.fas.fa-check
                p.mb-0.ps-2 Paneles o foros con expertos mediante <em>live-streaming.</em>
              li.fas.fa-check
                p.mb-0.ps-2 Vídeos animados con componentes de <em>storytelling.</em>
              li.fas.fa-check
                p.mb-0.ps-2 Aplicaciones móviles.
              li.fas.fa-check
                p.mb-0.ps-2 Infografías, gráficos y visualización de datos que apoyen el contenido.
              li.fas.fa-check
                p.mb-0.ps-2 Ludificación (gamificación en inglés).
          
      .row(numero="2" titulo="Paso 2")
        .col-md-12.mb-4.mb-md-0
          p  Identificar la plataforma que mejor se adapte a los objetivos del evento. Descargue el siguiente documento:     
      ...
      .row(numero="3" titulo="Paso 3")
        .col-md-12.mb-4.mb-md-0
          p Promocionar el evento con herramientas de comunicación digital de acuerdo al tipo de público: si el evento es enfocado al personal interno de una compañía, los canales a usar podrían ser los emails corporativos, periódico de la organización, intranet y grupos de redes sociales, etc.
      .row(numero="4" titulo="Paso 4")
        .col-md-12.mb-4.mb-md-0
          p Entregar instrucciones e información clara del evento: la plataforma en la que se desarrollará, los <i>links</i> o claves de acceso, el cronograma o agenda, los contactos para dudas o requerimientos y relacionar las reglas de comportamiento, como momentos en los que se pueden hacer preguntas entre otros aspectos.
      .row(numero="5" titulo="Paso 5")
        .col-md-12.mb-4.mb-md-0
          p Seguimiento a los participantes  a través de encuestas de percepción del evento, entre otros. Envío de materiales de apoyo como grabaciones de video o audio y cualquier otra información útil, dentro de las 48 horas siguientes a la finalización.

    .row.mt-5
      .col-lg-12
        h3 Montaje de eventos híbridos
      ...
      .col-lg-8
         ...
         p.mb-3 De forma presencial, normalmente, el número de asistentes es reducido, mientras en lo virtual la participación puede ser mayor ya que  se usan plataformas audiovisuales y tecnológicas a través de las cuales las personas se conectan desde diferentes ciudades de origen.
          .cajon.color_anexo2.p-4
            p.mb-0 <em>Streaming:</em> cualquier contenido de medios, ya sea en vivo o grabado, que se puede disfrutar en computadoras, celulares, tabletas, a través de internet y en tiempo real. Los<i> podcasts, webcasts</i>, las películas, los programas de TV y los videos musicales son tipos comunes de contenido de <i>streaming.</i>

    .row.mt-5
      .col-lg-9             
        p.mb-0 Es necesario conocer la diferencia entre eventos híbridos y la transmisión en directo de un evento físico. Para que un evento sea considerado ‘híbrido’ se debe crear ‘una experiencia única’ en la que los participantes, independientemente de su asistencia presencial o virtual, se puedan mover libremente a través de las plataformas, involucrarse, participar y disfrutar. 
      .col-lg-3
        img(src="@/assets/curso/temas/tema1/img8_tema_1.svg", alt="alt")

    .row.mt-5
      .col-lg-12
        p.mb-0 Para lo anterior, es importante la creación de un contenido de calidad, que sea dinámico, con el que se pueda interactuar en todo momento.        
      .col-lg-12.mt-5
        img(src="@/assets/curso/temas/tema1/2.jpg", alt="alt")

    .row.mt-5
      .col-lg-12
        p.mb-0 El beneficio más grande de este tipo de eventos, es que logran la unión entre los encuentros virtuales y los presenciales, aprovechando lo mejor de cada uno.      
   
    .row.mt-5.img_10_t2
      .col.lg-6
        img(src="@/assets/curso/temas/tema1/img10_tema_1.png", alt="alt")

    .row.mt-5
      .col-lg-3
        img(src="@/assets/curso/temas/tema1/img11_tema_1.svg", alt="alt").
      .col-lg-9
         p.mb-5 Sin embargo, la logística se multiplica al organizar un evento de este tipo, pues es necesario contar con los elementos para un encuentro presencial y los gastos que esto implica. También se debe  sumar la infraestructura necesaria de un evento <i>online</i> y las herramientas de ‘realidad virtual’.
    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta-tarjeta--azul").mt-5
      .row(titulo="Definir tipo de evento y objetivo")
        .col-md-4
          figure.img_10_t1
            img(src='@/assets/curso/temas/tema1/icon2_tema_1.svg', alt='Texto que describa la imagen')
        .col-md-8.mb-4.mb-md-0
          p Es importante contestar preguntas como las siguientes:
          ul.lista-ul--color.mt-3
            li.fas.fa-check
              p.mb-0.ps-2 ¿El evento consiste únicamente en una charla o hay alguna actividad adicional?
            li.fas.fa-check
              p.mb-0.ps-2 ¿Qué tipo de contenido se va a transmitir?
            li.fas.fa-check
              p.mb-0.ps-2 ¿El público debe interactuar de alguna manera?
            li.fas.fa-check
              p.mb-0.ps-2 ¿El público puede hacer preguntas o dar sus comentarios en vivo?
            li.fas.fa-check
              p.mb-0.ps-2 ¿Quieres que la audiencia pueda encender sus cámaras y micrófonos?
      
      .row(titulo="Identificar cantidad y características del público presencial y virtual.")  
        .col-md-4
          figure.img_10_t1
      ...
      .row(titulo="Elegir la mejor plataforma")
        .col-md-4
          figure.img_10_t1
            img(src='@/assets/curso/temas/tema1/icon4_tema_1.svg', alt='Texto que describa la imagen')
        .col-md-8.mb-4.mb-md-0
          p Se debe tener en cuenta el público objetivo y la popularidad de la plataforma en el mercado, el fácil acceso de los usuarios, el nivel de uso de los participantes y el valor a pagar en caso de que se cobre por descarga o por registro para el uso. 
      
      .row(titulo="Elegir un escenario acorde al evento y a la imagen que desea proyectar la compañía")
        .col-md-4
          figure.img_10_t1
            img(src='@/assets/curso/temas/tema1/icon5_tema_1.svg', alt='Texto que describa la imagen')
        .col-md-8.mb-4.mb-md-0
          p Según LinkedIn (2021), dentro de la modalidad de eventos digitales e híbridos hay 3 tipos de escenarios principales:
          ul.lista-ul--color.mt-3
            li.fas.fa-check
              p.mb-0.ps-2 <b>Escenario Virtual</b>. Hace referencia al escenario que los participantes que estarán conectados al evento de manera digital, van a visualizar.
            li.fas.fa-check
